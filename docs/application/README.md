...
## Quick start
1) Fill in your email credentials via environment variables.
- you can make an ```.env``` file at project root level with these properties:
```bash
...
![img.png](../pictures/google%20app%20passwords.png)
